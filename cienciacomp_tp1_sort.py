...
doSortFuncOnFile(OUT_PATH, bubbleSort, "./out_bubble4.txt", 10, 1000)
print("Bubble Sort (500)")
doSortFuncOnFile(OUT_PATH, bubbleSort, "./out_bubble5.txt", 10, 500)
print("Bubble Sort (100)")
doSortFuncOnFile(OUT_PATH, bubbleSort, "./out_bubble6.txt", 10, 100)
print("--------------------------------------------")
print("Selection Sort (10k)")
doSortFuncOnFile(OUT_PATH, selectionSort, "./out_select.txt")
print("Selection Sort (5k)")
doSortFuncOnFile(OUT_PATH, selectionSort, "./out_select2.txt", 10, 5000)
print("Selection Sort (2k)")
doSortFuncOnFile(OUT_PATH, selectionSort, "./out_select3.txt", 10, 2000)
print("Selection Sort (1k)")
doSortFuncOnFile(OUT_PATH, selectionSort, "./out_select4.txt", 10, 1000)
print("Selection Sort (500)")
doSortFuncOnFile(OUT_PATH, selectionSort, "./out_select5.txt", 10, 500)
print("Selection Sort (100)")
doSortFuncOnFile(OUT_PATH, selectionSort, "./out_select6.txt", 10, 100)
print("--------------------------------------------")
print("Insertion Sort (10k)")
doSortFuncOnFile(OUT_PATH, insertionSort, "./out_insert.txt")
print("Insertion Sort (5k)")
doSortFuncOnFile(OUT_PATH, insertionSort, "./out_insert2.txt", 10, 5000)
print("Insertion Sort (2k)")
doSortFuncOnFile(OUT_PATH, insertionSort, "./out_insert3.txt", 10, 2000)
print("Insertion Sort (1k)")
doSortFuncOnFile(OUT_PATH, insertionSort, "./out_insert4.txt", 10, 1000)
print("Insertion Sort (500)")
doSortFuncOnFile(OUT_PATH, insertionSort, "./out_insert5.txt", 10, 500)
print("Insertion Sort (100)")
doSortFuncOnFile(OUT_PATH, insertionSort, "./out_insert6.txt", 10, 100)
